    ...
    <header className="absolute inset-x-0 top-0 z-50 py-6">
      <Container>
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center absolute top-full left-0 lg:top-0 bg-body lg:bg-transparent border-x border-x-box-borders lg:border-x-0 lg:h-auto:">
